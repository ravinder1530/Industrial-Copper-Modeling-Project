...
with tab1:    
        ...
        if submit_button and flag==0:
            ...
            import pickle
            with open(r"D:/Ravi/Guvi/Copper/Industrial-Copper-Modeling-Project-main/source/model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)
            with open(r'D:/Ravi/Guvi/Copper/Industrial-Copper-Modeling-Project-main/source/scaler.pkl', 'rb') as f:
                scaler_loaded = pickle.load(f)

            with open(r"D:/Ravi/Guvi/Copper/Industrial-Copper-Modeling-Project-main/source/t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open(r"D:/Ravi/Guvi/Copper/Industrial-Copper-Modeling-Project-main/source/s.pkl", 'rb') as f:
            ...
            new_sample_ohe = t_loaded.transform(new_sample[:, [8]]).toarray()
